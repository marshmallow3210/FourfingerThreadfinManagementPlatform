        ...
        if request.method == "POST": 
            ...
            if update_logs == 'true' or update_logs == '1': 
                ...
                if feeding_logs_date_temp: 
                    ...
                    # sql = "select * from new_feeding_logs where start_time in ('2024-07-12 16:27:48', '2024-07-13 18:22:13', '2024-07-14 05:01:05', '2024-07-15 17:07:57', '2024-07-16 04:58:15', '2024-07-16 17:15:33', '2024-07-17 18:06:10', '2024-07-18 05:02:16', '2024-08-02 16:23:06', '2024-08-08 04:39:48');"
                    cursor.execute(sql)
                    new_feeding_data = list(cursor.fetchall())
